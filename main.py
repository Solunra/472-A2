...
def main():
    ...
    ttt.main(game_size=4, blocks=4, block_positions=[(0, 0), (0, 3), (3, 0), (3, 3)], win_length=3, max_execution_time=5, player_x_max_depth=6, player_o_max_depth=6, algo=ttt.Game.ALPHABETA)
